...
namespace _3DR
{
    class abtda2y
    {
        ...
        public virtual ICollection<abtda2yArkam> Abtda2YArkams { get; set; } = new List<abtda2yArkam>();
        public virtual ICollection<abtda2yAcces> Accesories { get; set; } = new List<abtda2yAcces>();
    }
}
