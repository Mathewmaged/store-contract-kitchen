...
// https://www.facebook.com/vbandcsharb
...
public class NumericToLiteral
{
    ...
    private const string Hundred = "مئة";
    ...
    public static string Convert(decimal a, bool Female = false, string SingleName = "", string PluralName = "")
    {
        ...
        string fractionalPart = (f > 0) ? Parse(f, false, "", "").TrimEnd(')') + " من " + Parse((long)Math.Pow(10, fractSize), false, "", "").TrimStart('(') : "";
